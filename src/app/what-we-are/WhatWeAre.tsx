    ...
    return (
        <section className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
                ...
                <div className="mb-8">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-6">We are here for:</h3>
                    <ul className="space-y-4 text-md text-gray-600 dark:text-gray-300">
                        <li className="flex items-center justify-center">
                            The overthinkers who can&apos;t switch off
                        </li>
                        <li className="flex items-center justify-center">
                            The strong ones who never ask for help
                        </li>
                        <li className="flex items-center justify-center">
                            The ones who smile outside but feel lost inside
                        </li>
                    </ul>
                </div>
